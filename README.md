...
Se crea el personal (recepcionista y veterinario)
Se registra un cliente
Se agregan mascotas al cliente
Se crean consultas para cada mascota
Se agregan tratamientos
Se generan facturas
Se realizan pagos con diferentes métodos
